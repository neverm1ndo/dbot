...
/***/ "./src/public/stylesheets/chat.css":
/*!*****************************************!*\
  !*** ./src/public/stylesheets/chat.css ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("data:text/css;charset=utf-8;base64,");
...
class BTTV {
  ...
  addEmotes(emotes, titleof) {
    ...
    for (let i = 0; i < emotes.length; i++) {
      ...
      new (bootstrap_js_dist_tooltip__WEBPACK_IMPORTED_MODULE_2___default())(img, {
...
class ChatMessage extends HTMLDivElement {
  ...
  addTooltipsToEmotes() {
    ...
    let tooltipList = tooltipTriggerList.map(function (tooltipTriggerEl) {
      return new (bootstrap_js_dist_tooltip__WEBPACK_IMPORTED_MODULE_3___default())(tooltipTriggerEl);
    });
  }
}
    ...
    _http__WEBPACK_IMPORTED_MODULE_0__["default"].get(`https://api.twitch.tv/helix/users?id=${[...streamers].join('&id=')}`, {
      ...
      for (let i = 0; i < ownersInfo.data.length; i++) {
        ...
        for (let j = 0; j < owners[ownersInfo.data[i].id].length; j++) {
          ...
          new (bootstrap_js_dist_tooltip__WEBPACK_IMPORTED_MODULE_3___default())(img, {
...
class PubSub {
  ...
  listen(id) {
    const message = {
        ...
        nonce: nonce(15),
        data: {
            topics: [`chat_moderator_actions.${_chat__WEBPACK_IMPORTED_MODULE_0__.user.id}.${id}`],
